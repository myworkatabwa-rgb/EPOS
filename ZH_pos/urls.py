...
urlpatterns = [
   ...
   # path("returns/", sale_returns),
    ...
    path('price-list/', views.items.price_list, name='price_list'),
    path('ajax/get-item/', views.items.get_item_by_barcode, name='get_item_by_barcode'),
    path('price-list/save/', views.items.save_price_list, name='save_price_list'),
