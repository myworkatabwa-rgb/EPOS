...
urlpatterns = [
   ...
   # INVENTORY
    ...
    path("purchase/",                              purchase_order_list,       name="purchase_order_list"),
    path("purchase/create/",                       purchase_order_create,     name="purchase_order_create"),
    path("purchase/<int:pk>/",                     purchase_order_detail,     name="purchase_order_detail"),
    path("purchase/<int:pk>/receive/",             purchase_order_receive,    name="purchase_order_receive"),
    path("purchase/delete/<int:pk>/",              purchase_order_delete,     name="purchase_order_delete"),
    path("purchase/load-demand-items/",            load_demand_sheet_items,   name="load_demand_sheet_items"),
    path("purchase/search-product/",               search_product_for_po,     name="search_product_for_po"),
