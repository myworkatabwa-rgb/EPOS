...
urlpatterns = [
   ...
   # path("returns/", sale_returns),
    ...
    path("itmes/promotions/list/", promotion_list, name="promotion_list"),
    ...
    path("items/ajax/get-categories-items/", views.items.get_categories_and_items, name="get_categories_items"),
    path("items/ajax/get-filtered-data/", views.items.get_filtered_data, name="get_filtered_data"),
