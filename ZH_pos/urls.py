...
urlpatterns = [
    ...
    path("accounts/add-account/",                    add_account,          name="add_account"),
    path("accounts/add-account-group/",              add_account_group,    name="add_account_group"),
    path("accounts/edit-account/<int:pk>/",          edit_account,         name="edit_account"),
