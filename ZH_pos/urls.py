...
urlpatterns = [
   ...
   # INVENTORY
    ...
    path("inventory/grn/<int:pk>/",         grn_detail,            name="grn_detail"),
    path("inventory/grn/delete/<int:pk>/",  grn_delete,            name="grn_delete"),
    path("inventory/grn_load-po-items/",    load_po_items,         name="load_po_items"),
    path("inventory/grn_fetch-product/",    fetch_product_for_grn, name="fetch_product_for_grn"),
    ...
    path("inventory/goods-receive-return-note/", grn_return_list, name="grn_return_list"),
